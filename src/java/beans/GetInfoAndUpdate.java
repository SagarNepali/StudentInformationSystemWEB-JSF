...
public class GetInfoAndUpdate {
    ...
    public List<GetInfoAndUpdate> getAllImage() {
        ...
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost/studentinformationsystem", "root", "");
...
//                    setProgram(null);
    ...
    public void infoUpdate() {
        ...
        try {
            Class.forName("com.mysql.jdbc.Driver");
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost/studentinformationsystem", "root", "12345");
