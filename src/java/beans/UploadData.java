    ...
    public void upload() {
        ...
        if (file != null) {
            try {
                ...
                pre6.setString(1, id);
                pre6.setString(2, f_name);
                pre6.setString(3, f_occupation);
                pre6.setString(4, f_address);
                pre6.setString(5, f_mobilno);
                pre6.setString(6, f_phone_no);
                ...
                pre7.setString(6, plus2Percentage);
                ...
                pre8.setString(6, slcPercentage);
